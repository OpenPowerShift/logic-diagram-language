...
. The renderer MUST avoid routing wires through gate bodies. When a preferred channel would intersect a gate body, the renderer MUST search for a clear channel to the right.
