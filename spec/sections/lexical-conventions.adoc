...
Within string-valued attributes (`.Name` and `.Description`), AsciiMath notation is enclosed in dollar signs:

* `$...$` -- Inline AsciiMath expression.
* `\\$` -- Escaped literal dollar sign (renders as `$`).
